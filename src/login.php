                    ...
                    ?>
                            ...
                            <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                              ...
                              <div class="form-outline mb-4 input-group"> 
                                ...
                                <input type="text" id="form4Example1" class="form-control" name="username" onblur="validater()"> 
                              ...
                              <div class="form-outline mb-4 input-group">
                                ...
                                <input type="password" id="form4Example2" class="form-control" name="password" onblur="validater()">
                              ...
                              <div class="form-check d-flex justify-content-center mb-4"> 
                                <label class="form-check-label">Don't have an account? <br><a href="registration.php">Sign Up here!</a></label> </div> 

                                  <!-- Submit button -->
                              <button type="submit" class="btn btn-primary btn-block"
                                aria-controls="#picker-editor" id="send"><i class="fas fa-sign-in-alt"></i> &nbsp;Sign in</button>
                            </form>
