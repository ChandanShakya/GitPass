...
<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $title = $_POST['title'];
        $site = "https://".$_POST['site'];
        $username = $_POST['username'];
        $password = $_POST['password'];
        $userId = $_SESSION['unique_id'];
        $conn->query("INSERT INTO passwords(title, site, username, password, user_id) VALUES ('{$title}', '{$site}', '{$username}', '{$password}', {$userId});");
      ...
      <div data-draggable="true" style="position: relative;" class="">
        ...
        <section draggable="false" class="overflow-hidden pt-0" data-v-271253ee="">
          <section class="mb-10 position-relative">
            <!-- Animated SVG --> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              class="position-absolute"
              style=" margin: auto; display: block; width: 100%; z-index: 0; position: relative; "
            ...
            <div class="container">
              <div class="d-flex justify-content-center text-center pt-5">
                <div class="p-4 rounded-6 shadow-3-strong w-75 mt-5"
                  style="background-color: hsla(0, 0%, 100%, 0.8) !important; backdrop-filter: saturate(200%) blur(25px);;">

                  <div class="mb-4 mb-lg-0 position-relative"> <a href="home.php"><img
                    src="https://raw.githubusercontent.com/ZXY-CC-3ag13/GitPass/main/src/img/brand.svg"
                    class="text-primary" alt="Logo" aria-controls="#picker-editor" style="width:5em;"> </a></div>
                          ...
                          <form name="submit-new" id="submit-new" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                            ...
                            <!-- Title input -->
                              ...
                              <div class="form-outline mb-4 input-group"> 
                                ...
                                <input type="text" id="form4Example1" class="form-control" name="title" onblur="validateForm()"> 
                              ...
                              <div class="form-outline mb-4 input-group"> 
                                ...
                                <input type="text" id="form4Example2" class="form-control" name="site" onblur="validateForm()"> 
                              ...
                              <div class="form-outline mb-4 input-group">
                                ...
                                <input type="text" id="form4Example3" class="form-control" name="username" onblur="validateForm()">
                              ...
                              <div class="form-outline mb-4 input-group">
                                ...
                                <input type="password" id="form4Example4" class="form-control" name="password" onblur="validateForm()">
                              ...
                              <div class="form-check d-flex justify-content-center mb-4"> 
                                <label class="form-check-label">We'll never share your password with anyone else.</label> </div> 
