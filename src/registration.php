                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        ?> <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                            ...
                                            <div class="form-outline mb-4 input-group">
                                                ...
                                                <input type="text" id="form4Example1" class="form-control" name="username" oninput="validateUsername();validater()">
                                            ...
                                            <div class="form-outline mb-4 input-group">
                                                <span class="input-group-text" style="width: 2.5em;"><i class="fas fa-at"></i></span>
                                                <input type="email" id="form4Example2" class="form-control" name="email" oninput="validateEmail();validater()">
                                                <label class="form-label" for="form4Example2" style="margin-left: 0px;">E-mail</label>
                                                <div class="form-notch">
                                                    <div class="form-notch-leading" style="width: 9px;"></div>
                                                    <div class="form-notch-middle" style="width: 42.4px;"></div>
                                                    <div class="form-notch-trailing"></div>
                                            ...
                                            <div class="form-outline mb-4 input-group">
                                                ...
                                                <input type="password" id="form4Example3" class="form-control" name="password" oninput="validatePassword();validater()">
                                                <label class="form-label" for="form4Example3" style="margin-left: 0px;">New Password</label>
                                                <div class="form-notch">
                                                    <div class="form-notch-leading" style="width: 9px;"></div>
                                            ...
                                            <div class="form-outline mb-4 input-group">
                                                <span class="input-group-text" style="width: 2.5em;"><i class="fas fa-key"></i></span>
                                                <input type="password" id="form4Example4" class="form-control" name="password2" oninput="validateConfirmationPassword();validater()">
                                                <label class="form-label" for="form4Example4" style="margin-left: 0px;">Confirm Password</label>
                                                <div class="form-notch">
                                                    <div class="form-notch-leading" style="width: 9px;"></div>
                                                    <div class="form-notch-middle" style="width: 88.8px;"></div>
                                                    <div class="form-notch-trailing"></div>
                                            ...
                                            <div class="form-check d-flex justify-content-center mb-4">
                                                <label class="form-check-label">Already have an account? <br><a href="login.php">Log In here!</a></label>
                                            </div>

                                            <!-- Submit button -->
                                            <button type="submit" class="btn btn-primary btn-block" aria-controls="#picker-editor" id="send" disabled="disabled"><i class="fas fa-sign-in-alt"></i> &nbsp;Register</button>
                                        </form>
