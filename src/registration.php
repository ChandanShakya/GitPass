        ...
        <div data-draggable="true" style="position: relative;" class="">
            ...
            <section draggable="false" class="overflow-hidden pt-0" data-v-271253ee="">
                <section class="mb-10 position-relative">
                    <!-- Animated SVG --> <svg xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" class="position-absolute"
                        ...
                        <div class="d-flex justify-content-center text-center pt-5">
                            <div class="p-4 rounded-6 shadow-3-strong w-75 mt-5"
                                ...
                                <div class="mb-4 mb-lg-0 position-relative"> <a href="home.php"><img
                                            ...
                                            class="text-primary" alt="Logo" aria-controls="#picker-editor"
                                            style="width:5em;"> </a></div>
                        ...
                        ?>
                                        ...
                                        <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                                            ...
                                            <div class="form-outline mb-4 input-group">
                                                <span class="input-group-text" style="width: 2.5em;"><i
                                                        class="fas fa-user"></i></span>
                                                <input type="text" id="form4Example1" class="form-control"
                                                    name="username" onblur="validater()">
                                            ...
                                            <div class="form-outline mb-4 input-group">
                                                ...
                                                <label class="form-label" for="form4Example2"
                                                    style="margin-left: 0px;">E-mail</label>
                                                <div class="form-notch">
                                                    <div class="form-notch-leading" style="width: 9px;"></div>
                                                    <div class="form-notch-middle" style="width: 42.4px;"></div>
                                                    <div class="form-notch-trailing"></div>
                                            ...
                                            <div class="form-outline mb-4 input-group">
                                                ...
                                                <input type="password" id="form4Example3" class="form-control"
                                                    name="password" onblur="validater()">
                                                <label class="form-label" for="form4Example3"
                                                    style="margin-left: 0px;">New Password</label>
                                                <div class="form-notch">
                                                    <div class="form-notch-leading" style="width: 9px;"></div>
                                            ...
                                            <div class="form-outline mb-4 input-group">
                                                ...
                                                <input type="password" id="form4Example4" class="form-control"
                                                    name="password2" onblur="validater()">
                                                <label class="form-label" for="form4Example4"
                                            ...
                                            <button type="submit" class="btn btn-primary btn-block"
                                                aria-controls="#picker-editor" id="send" disabled="disabled"><i
